/*
 * sit.c - userspace sit(IPv6 over IPv4) tunnel
 *
...
int main(int argc, char **argv)
{
	...
	local.sin_port = htons(IPPROTO_IPV6);
	...
	remote.sin_port = htons(IPPROTO_IPV6);
...
static void tun_cb(void)
{
	...
	sendto(sock, buf, n, 0, (struct sockaddr *)&remote, sizeof(struct sockaddr));
}
